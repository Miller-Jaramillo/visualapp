        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <div class="text-center mt-5 text-4xl font-extrabold ...">
                        <span
                            class="tracking-widest  uppercase bg-clip-text text-transparent bg-gradient-to-r dark:from-gray-50 dark:to-indigo-900
                        from-gray-100 to-blue-500">
                            VISUALAPP
                        </span>
                    </div>
                ...
                <div class=" sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <div>
                            <div class="">
                                <x-input id="email"
                                    ...
                                    autocomplete="username" placeholder="{{ __('Correo electronico') }}" />
                            </div>
                        </div>
                    ...
                    <p class="mt-2 text-center text-md dark:text-gray-400 text-white tracking-widest">
                        <a href="{{ route('register-user.create') }}"
                            class="font-bold uppercase  text-xs tracking-widest leading-6 dark:text-green-500 text-green-500 hover:text-green-500 dark:hover:text-green-400">Crear
                            nueva cuenta</a>
                    </p>
                </div>
